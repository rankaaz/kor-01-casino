// SEO 키워드 (검색 스니펫에만 사용, 소스엔 안 노출)
document.title = "2025년 카지노사이트 추천 순위 TOP 12 | 안전 바카라 & 슬롯 BEST";
document.head.innerHTML += '<meta name="description" content="2025년 검증된 카지노사이트 BEST 12 공개! 안전 바카라, 슬롯, 룰렛 게임 + 꽁머니 5만원 즉시 지급. 먹튀 ZERO, 빠른 출금 보장. 지금 가입하고 200% 첫충 보너스 받으세요!">';

// 진짜 이동할 URL (여기만 바꾸세요)
const REAL_URL = "https://pig77.com";

// 즉시 DOM 교체 (로딩 스피너 사라지고 보라색 등장)
